...
public class ReflectionWithAnnotationDemo {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        System.out.println("------------------------------------");
        System.out.println(startingDate); //null
        ...
        System.out.println(startingDate); //2024-01-23
        System.out.println("------------------------------------");

        Method printDep12DetailsMethod = ReflectionWithAnnotationDemo.class.getDeclaredMethod("printDep12Details",int.class,String.class);
        Dep12 methodAnnotation = printDep12DetailsMethod.getDeclaredAnnotation(Dep12.class);
        printDep12DetailsMethod.invoke(ReflectionWithAnnotationDemo.class, methodAnnotation.duration(), methodAnnotation.startingDate());
